...
export default function EmailInputPage() {
  ...
  const handleEmailChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (newEmail.trim() === "") {
      ...
      setEmailError(
        userCountry === "ua" ? "Будь ласка, введіть дійсну електронну адресу" : "Please enter a valid email address",
      )
      setIsValidEmail(false)
    } else {
      setEmailError("")
  ...
  const handleNext = () => {
    if (isValidEmail && email.trim()) {
      ...
      if (userCountry === "ua") {
        ...
        router.push("/personal-data/name")
      }
    }
  }
        ...
        <div className="relative bg-white rounded-2xl p-6 border border-gray-100 min-h-[500px] flex flex-col">
          ...
          <div className="flex-1 space-y-6 mb-6">
            <h1 className="text-xl font-bold text-[#303030] text-left">
              {userCountry === "ua" ? "Яка ваша електронна пошта?" : "What's your email?"}
            </h1>
