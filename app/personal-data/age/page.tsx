...
export default function AgeInputPage() {
  ...
  const handleSubmit = () => {
    if (age.trim()) {
      ...
      // Always redirect to the main completion page
        ...
        <div className="relative bg-white rounded-2xl p-6 border border-gray-100 min-h-[500px] flex flex-col">
          ...
          <div className="flex-1 space-y-6 mb-6">
            <h1 className="text-xl font-bold text-[#303030] text-left">
              {userCountry === "ua" ? "Скільки вам років?" : "What is your age?"}
            </h1>
            ...
            <div className="space-y-6">
              <Input
                ...
                placeholder={userCountry === "ua" ? "Вік" : "Age"}
              />
              <button
              ...
              >
                {userCountry === "ua" ? "Отримати результат" : "Get result"}
              </button>
            </div>
          </div>
